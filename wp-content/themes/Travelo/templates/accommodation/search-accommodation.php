<?php
/**
* Accommodation Search Template
 */

get_header();
global $def_currency, $current_view, $trav_options, $search_max_rooms, $search_max_adults, $search_max_kids, $language_count;

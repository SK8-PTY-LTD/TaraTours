		...
		<div class="wrap">
			...
			<form method="post" onsubmit="return manage_schedule_validateForm();">
				...
				<table class="trav_admin_table trav_tour_schedule_manage_table">
					...
					<tr class="price">
						<th>Price</th>
						<td><input type="number" name="price" value="<?php echo esc_attr( $schedule_data['price'] ); ?>"></td>
					</tr>
					<tr class="child_price">
						<th>Price Per Child</th>
						<td><input type="number" name="child_price" value="<?php echo esc_attr( $schedule_data['child_price'] ); ?>"></td>
					</tr>
				</table>

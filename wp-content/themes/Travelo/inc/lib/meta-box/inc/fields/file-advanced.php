            ...
            <script id="tmpl-rwmb-file-advanced" type="text/html">
				...
				<li>
					...
					<div class="rwmb-info">
						...
						<p>{{{ attachment.mime }}}</p>
						<a title="<?php echo esc_attr( $i18n_edit ); ?>" href="{{{ attachment.editLink }}}" target="_blank"><?php echo wp_kses_post( $i18n_edit ); ?></a> |
						<a title="<?php echo esc_attr( $i18n_delete ); ?>" class="rwmb-delete-file" href="#" data-attachment_id="{{{ attachment.id }}}"><?php echo wp_kses_post( $i18n_delete ); ?></a>
					</div>
				</li>
				<# } ); #>
			</script>

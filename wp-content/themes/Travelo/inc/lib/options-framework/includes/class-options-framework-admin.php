...
class Options_Framework_Admin {
    ...
    public function init() {
        ...
        // install main pages if install_trav_pages button is clicked.
        if ( ! empty( $_GET['install_trav_pages'] ) ) {
            ...
            if ( empty( $installed ) ) {
                ...
                update_option( $config['id'], $trav_options );
            }
        }
    ...
    function enqueue_admin_styles( $hook ) {
        ...
        wp_enqueue_style( 'optionsframework', OPTIONS_FRAMEWORK_DIRECTORY_URL . 'css/optionsframework.css', array(),  Options_Framework::VERSION );
    ...
    function enqueue_admin_scripts( $hook ) {
        ...
        wp_enqueue_script( 'options-custom', OPTIONS_FRAMEWORK_DIRECTORY_URL . 'js/options-custom.js', array( 'jquery','wp-color-picker' ), Options_Framework::VERSION );
            ...
            <?php settings_errors( 'options-framework' ); ?>
                <form action="options.php" method="post">
                    ...
                    <div class="of-container">
                        <div class="of-content-back"></div>
                        <div class="of-content">
                            <div class="of-sidebar">
                                <?php echo Options_Framework_Interface::optionsframework_tabs(); ?>
                            </div>
                            <div class="of-right-sidebar">
                                <ul>
                                    <li>
                                        <a href="http://www.soaptheme.net/document/travelo-wp/">Online Documentation</a>
                                    </li>
                                    <!-- <li>
                                        <a href="http://www.soaptheme.com/">FAQ</a>
                                    </li> -->
                                </ul>
                            </div>
                            <div class="of-metabox">

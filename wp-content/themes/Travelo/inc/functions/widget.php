...
class TravTweetsWidget extends WP_Widget {
	...
	function TravTweetsWidget() {
		$widget_ops = array('classname' => 'twitter-box', 'description' => '');
		$control_ops = array('id_base' => 'tweets-widget');
		$this->WP_Widget('tweets-widget', 'Travelo Twitter Widget', $widget_ops, $control_ops);
	}
...
class TravNewsWidget extends WP_Widget {
	...
	function TravNewsWidget() {
		...
		$this->WP_Widget( 'news-widget', 'Travelo News Widget', $widget_ops, $control_ops );
	}
...
class TravSocialLinksWidget extends WP_Widget {
	...
	function TravSocialLinksWidget() {
		$widget_ops = array('classname' => 'social_links', 'description' => '');
		$control_ops = array('id_base' => 'social_links-widget');
		$this->WP_Widget('social_links-widget', 'Travelo Social Links Widget', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance) {
		...
		<li class="skype"><a title="skype" href="<?php echo esc_url( $instance['skype_link'] ); ?>" target="<?php echo esc_attr( $instance['linktarget'] ); ?>" data-toggle="tooltip"><i class="soap-icon-skype"></i></a></li>
		<?php endif; ?>
...
class TravNavMenuWidget extends WP_Nav_Menu_Widget {

	function TravNavMenuWidget() {
		$widget_ops = array('classname' => 'widget_nav_menu', 'description' => '');
		$control_ops = array('id_base' => 'trav-nav_menu-widget');
		$this->WP_Widget('trav-nav_menu-widget', 'Travelo Custom Menu', $widget_ops, $control_ops);
	}

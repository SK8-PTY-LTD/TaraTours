															...
															<select class="full-width" id="select-room-type">
																...
																<?php
																	foreach ( $room_types as $room_type ) {
																		echo '<option value="' . esc_attr( $room_type->ID ) . '">' . get_the_title($room_type->ID) . '</option>';
																	}
																?>
															</select>
														</div>
							...
							<div class="tab-content">
								...
								<div class="tab-pane fade" id="hotel-reviews">
									...
									<div class="guest-reviews">
										<h2><?php echo __('Guest Reviews', 'trav') . ' <small>('; echo esc_html( trav_get_review_count( $acc_id ) . ' ' .  __('reviews', 'trav') . ')' ); ?></small></h2>
										<?php
											$per_page = 10;
											$review_count = trav_get_review_html($acc_id, 0, $per_page);
										?>
									</div>
